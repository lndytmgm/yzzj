    ...
    window.elFinder = function (b, c) {
        ...
        this.api = null, this.newAPI = !1, this.oldAPI = !1, this.OS = navigator.userAgent.indexOf("Mac") !== -1 ? "mac" : navigator.userAgent.indexOf("Win") !== -1 ? "win" : "other", this.UA = function () {
            ...
            var b = this, c = a.Deferred().done(function () {
                ...
                preventDefault: !0
            }, e = {data: {cmd: "tree", target: p == this.root() ? p : this.file(p).phash}, preventDefault: !0};
        ...
        a.extend(a.ui.keyCode, {
            ...
            c && c != "" && c != "no" && a(B).html('<source src="./sounds/rm.wav" type="audio/wav">'
            )[0].play()
        ...
        uploads: {
            checkFile: function (b) {
                ...
                var d = c ? c : this, e = b.input ? b.input : !1, f = e ? !1 : d.uploads.checkFile(b), g = a.Deferred().fail(function (a) {
                    a && d.error(a)
                }).done(function (a) {
                ...
                }), f = new XMLHttpRequest, g = new FormData, h = b.input ? b.input.files : d.uploads.checkFile(b), i = h.length, j = 5, k = !1, l = function () {
        ...
        uiOptions: {
            toolbar: [["back", "forward"], ["netmount"], ["mkdir", "mkfile", "upload"], ["open", "download", "getfile"], ["info"], ["quicklook"], ["copy", "cut", "paste"], ["rm"], ["duplicate", "rename", "edit", "resize", "pixlr"], ["extract", "archive"], ["search"], ["view", "sort"], ["help"]],
        ...
        return this.each(function () {
            ...
            }), d = b.direction == "ltr" ? "left"
                : "right", e = a.extend({}, b.options.contextmenu), f = '<div class="elfinder-contextmenu-item"><span class="elfinder-button-icon {icon} elfinder-contextmenu-icon"/><span>{label}</span></div>', g = function (b, c, d) {
        ...
        return this.not(".elfinder-cwd").each(function () {
            var d = b.viewType == "list", e = "undefined", f = "select." + b.namespace, g = "unselect." + b.namespace, h = "disable." + b.namespace, i = "enable." + b.namespace, j = "class", k = b.res(j, "cwdfile"), l = "." + k, m = "ui-selected", n = b.res(j, "disabled"), o = b.res(j, "draggable"), p = b.res(j, "droppable"), q = b.res(j, "hover"), r = b.res(j, "adroppable"), s = k + "-tmp", t = b.options.loadTmbs > 0 ? b.options.loadTmbs : 5, u = "", v = [], w = {
                ...
                row: '<tr id="{hash}" class="' + k + ' {permsclass} {dirclass}" title="{tooltip}"><td><div class="elfinder-cwd-file-wrapper"><span class="elfinder-cwd-icon {mime}"/>{marker}<span class="elfinder-cwd-filename">{name}</span></div></td><td>{perms}</td><td>{date}</td><td>{size}</td><td>{kind}</td></tr>'
            }, x = b.res("tpl", "perms"), y = b.res("tpl", "symlink"), z = {
                ...
                if (c.oldSchool && g && !u) {
                    ...
                    i = a(A(i)).addClass
                    ("elfinder-cwd-parent").bind("mousedown click mouseup dblclick mouseenter", function (a) {
                ...
                b.trigger("hover", {hash: a(this).attr("id"), type: c.type}), a(this).toggleClass("ui-state-hover")
                ...
                filter: l, stop: I, selected: function (b, c) {
        ...
        return this.each(function () {
            ...
            }), w = u.children("." + b.res(e, "navsubtree")), x = a(this).addClass(b.res(e, "tree") + " elfinder-places ui-corner-all").hide().append(u).appendTo(b.getUI("navbar")).delegate("." + f, "mouseenter mouseleave", function () {
                a(this).toggleClass("ui-state-hover")
        ...
        return this.each(function () {
            var c = b.fm, d = b.name, e = "class", f = c.res(e, "disabled"), g = c.res(e, "hover"), h = "elfinder-button-menu-item", i = h + "-selected", j = i + "-asc"
                , k = i + "-desc", l = a(this).addClass("ui-state-default elfinder-button elfinder-menubutton elfiner-button-" + d).attr("title", b.title).append('<span class="elfinder-button-icon elfinder-button-icon-' + d + '"/>').hover(function (a) {
        ...
        return this.not("." + d).each(function () {
            ...
            }, u = b.droppable.drop, v = a.extend(!0, {}, b.droppable, {
                over: function (b) {
                    var c = a(this), d = p + " " + o;
            ...
            }), w = a(b.res("tpl", "navspinner")), x = b.res("tpl", "navdir"), y = b.res("tpl", "perms"), z = b.res("tpl", "symlink"), A = {
                id: function (a) {
            ...
            b.open(function (a) {
                ...
                var d = c.type == "lockfiles", e = d ? "disable" : "enable", f =
        ...
        this.tpl = {
            ...
            j == 1 ? (v = i[0], l = l.replace("{class}", f.mime2class(v.mime)), w = g.itemTitle.replace("{name}", f.escape(v.i18 || v.name)).replace
        ...
        this.alwaysEnabled = !0, this.updateOnSelect = !1, this.drivers = [], this.handlers = {
            ...
            var c = b.fm, d = a.Deferred(), e = b.options, f = function () {
                var f = {
                    ...
                    buttons: {}
                }, h = a('<table class="elfinder-info-tb elfinder-netmount-tb"/>'), i = a("<div/>");
                return h.append(a("<tr/>").append(a("<td>" + c.i18n("protocol") + "</td>")).append(a("<td/>").append(f.protocol))), a.each(b.drivers, function (b, d) {
                    ...
                    var c = f.protocol.val(), e = {cmd: "netmount", protocol: c};
                    ...
                    if (!e.host)return b.fm.trigger("error", {error: "errNetMountHostReq"});
                    b.fm.request({data: e, notify: {type: "netmount", cnt: 1}}).done(function () {
                        d.resolve()
                    }).fail(function (a) {
                        d.reject(a)
                    ...
                    label: "btnUnmount", callback: function () {
                        d.request({
                            data: {
                                ...
                                user: "dum",
                                pass: "dum"
                            }, notify: {type: "netunmount", cnt: 1}, preventFail: !0
                        }).fail(function (a) {
                            e.reject(a)
                        }).done(function (a) {
                            e.promise()
        ...
        this.alwaysEnabled = !0, this._handlers = {
            ...
            var c = this.fm, d = a.Deferred().fail(function (a) {
                a && c.error(a)
            }), e = this.files(b), f = e.length, g, h, i, j, k, l, m, n;
        ...
        this.updateOnSelect = !1, this.getstate = function (a) {
            ...
            var c = this.fm, d = a.Deferred().fail(function (a) {
                ...
                title: "Pixlr Editor or Pixlr Express ?", width: "auto", close: function () {
                    a(this).elfinderdialog("destroy")
                }
            };
        ...
        this.updateOnSelect = !1, this.getstate = function () {
            ...
            var c = this.fm, d = this.files(b), e = a.Deferred(), f = function (b, d) {
                var f = a('<div class="elfinder-dialog-resize"/>'), g = '<input type="text" size="5"/>', h = '<div class="elfinder-resize-row"/>', i = '<div class="elfinder-resize-label"/>', j = a('<div class="elfinder-resize-control"/>'), k = a('<div class="elfinder-resize-preview"/>'), l = a('<div class="elfinder-resize-spinner">' + c.i18n("ntfloadimg") + "</div>"), m = a('<div class="elfinder-resize-handle"/>'), n = a('<div class="elfinder-resize-handle"/>'), o = a('<div class="elfinder-resize-uiresize"/>'), p = a('<div class="elfinder-resize-uicrop"/>'), q = '<div class="ui-widget-content ui-corner-all elfinder-buttonset"/>', r = '<div class="ui-state-default elfinder-button"/>', s = '<span class="ui-widget-content elfinder-toolbar-button-separator"/>', t = a('<div class="elfinder-resize-rotate"/>'), u = a(r).attr("title", c.i18n("rotate-cw")).append(a('<span class="elfinder-button-icon elfinder-button-icon-rotate-l"/>').click(function () {
                    S -= 90, ba.update(S)
                })), v = a(r).attr("title", c.i18n("rotate-ccw")).append(a('<span class="elfinder-button-icon elfinder-button-icon-rotate-r"/>'
                ).click(function () {
                        S += 90, ba.update(S)
                    ...
                    mouseStartAngle: 0, imageStartAngle: 0, imageBeingRotated: !1, update: function (a, b) {
                ...
                X.mousedown(ba.start), a(document).mouseup(ba.stop), o.append(a(h).append(a(i).text(c.i18n("width"))).append(B).append(x)).append(a(h).append(a(i).text(c.i18n("height"))).append(C)).append(a(h).append(a("<label/>").text(c.i18n("aspectRatio")).prepend(A))).append(a(h).append(c.i18n("scale") + " ").append(w)), p.append(a(h).append(a(i).text("X")).append(D)).append(a(h).append(a(i).text("Y")).append(E)).append(a(h).append(a(i).text(c.i18n("width"))).append(F)).append(a(h).append(a(i).text(c.i18n("height"))).append(G)), t.append(a(h).append(a(i).text(c.i18n("rotate"))).append(a('<div style="float:left; width: 130px;">').append(a('<div style="float:left;">').append(H).append(a("<span/>").text(c.i18n("degree")))).append(a(q).append(u).append(a(s)).append(v))).append(I)), f.append(y), j.append(a(h)).append(o).append(p.hide()).append(t.hide()).find("input,select").attr("disabled", "disabled"), m.append('<div class="' + bg + " " + bg + '-top"/>').append('<div class="' + bg + " " + bg + '-bottom"/>').append('<div class="' + bh + " " + bh + '-left"/>').append('<div class="' + bh + " " + bh + '-right"/>').append('<div class="' + bi + " " + bi + '-e"/>').append('<div class="' + bi + " " + bi + '-se"/>').append('<div class="' + bi + " " + bi + '-s"/>'), k.append(l).append(m.hide()).append(T.hide()), n.css("position", "absolute").append('<div class="' + bg + " " + bg + '-top"/>').append('<div class="' + bg + " " + bg + '-bottom"/>').append('<div class="' + bh + " " + bh + '-left"/>').append('<div class="' + bh + " " + bh + '-right"/>').append('<div class="' + bi + " " + bi + '-n"/>').append('<div class="' + bi + " " + bi + '-e"/>').append('<div class="' + bi + " " + bi + '-s"/>').append('<div class="' + bi + " " + bi + '-w"/>').append('<div class="' + bi + " " + bi + '-ne"/>').append('<div class="' + bi + " " + bi + '-se"/>').append('<div class="' + bi + " " + bi + '-sw"/>').append('<div class="' + bi + " " + bi + '-nw"/>'), k.append(U.css("position", "absolute").hide().append(V).append(n.append(W))), k.append(X.hide()), k.css("overflow", "hidden"), f.append(k).append(j), bf[c.i18n("btnCancel")] = function () {
                    ...
                    title: b.name, width: 650, resizable: !1, destroyOnClose: !0, buttons: bf, open: function () {
                        k.zIndex
                        (1 + a(this).parent().zIndex())
                    }
