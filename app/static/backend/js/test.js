...
!function (a) {
    "function" == typeof define && define.amd ? define(["jquery.md5"], a) : "object" == typeof exports ? module.exports = a : a(jQuery)
}(function (a) {
    function b(b) {
...
$(document).ready(function () {
    ...
    jQuery(".responsive a").on("click", function () {
        var e = jQuery(this);
        for (device in i)e.hasClass(device) && (clicked = device, jQuery("#iframe").width(i[device]), clicked == device && (jQuery(".responsive a").removeClass("active"), e.addClass("active")));
        return !1
